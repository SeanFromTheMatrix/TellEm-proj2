...
class ThreePageTVC: UITableViewController {
    
    var newsCategories : [Article] = []

    let item2 = ["the-wall-street-journal"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.articleImage.downloadImageFrom2(link: newsCategories[indexPath.row].imageURL)
...
extension UIImageView {
    func downloadImageFrom2(link: String)  {
